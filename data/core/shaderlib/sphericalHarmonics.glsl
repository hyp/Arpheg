//GLSL spherical harmonics structure and lighting.

struct SphericalHarmonics {
    vec3 L00, L1m1, L10, L11, L2m2, L2m1, L20, L21, L22;
};

SphericalHarmonics sphericalHarmonicsGroove = SphericalHarmonics(
...
SphericalHarmonics sphericalHarmonicsBeach = SphericalHarmonics(
...
SphericalHarmonics sphericalHarmonicsTomb = SphericalHarmonics(
...
vec3 sphericalHarmonicsEval(vec3 normal, SphericalHarmonics l){
    float x = normal.x;
    float y = normal.y; 
    float z = normal.z; 
